...
public final class DaggerApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends App_HiltComponents.ActivityC {
    ...
    private MainActivity injectMainActivity2(MainActivity instance) {
      MainActivity_MembersInjector.injectMainDb(instance, singletonCImpl.provideMainDbProvider.get());
      return instance;
    }
  }
  ...
  private static final class SingletonCImpl extends App_HiltComponents.SingletonC {
    ...
    private dagger.internal.Provider<MainDb> provideMainDbProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.provideMainDbProvider = DoubleCheck.provider(new SwitchingProvider<MainDb>(singletonCImpl, 0));
    }
    ...
    private static final class SwitchingProvider<T> implements dagger.internal.Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.smartfridge.data.MainDb 
          return (T) Module_ProvideMainDbFactory.provideMainDb(ApplicationContextModule_ProvideApplicationFactory.provideApplication(singletonCImpl.applicationContextModule));
